...
const VoiceCard: React.FC<VoiceCardProps> = ({ voice, isPlaying, onPlayToggle, language = 'en' }) => {
        ...
        <div className="flex items-center justify-between mb-1">
            ...
            <div className="flex gap-1">
                <span className="inline-flex items-center px-2 py-0.5 border border-zinc-100 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900/50 text-[10px] font-medium text-zinc-500 dark:text-zinc-400 rounded-full">
                    {language === 'vi' && voice.analysis.gender === 'Female' ? 'Nữ' : language === 'vi' && voice.analysis.gender === 'Male' ? 'Nam' : voice.analysis.gender}
                </span>
                <span className="inline-flex items-center px-2 py-0.5 border border-zinc-100 dark:border-zinc-700 bg-zinc-50 dark:bg-zinc-900/50 text-[10px] font-medium text-zinc-500 dark:text-zinc-400 rounded-full">
                    {voice.pitch}
                </span>
